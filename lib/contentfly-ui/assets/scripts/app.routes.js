  ...
  function stateProvider($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider.state({
      ...
      templateUrl: function ($stateParams){
        if(extendedRoutes['default'] &&  extendedRoutes['default'][0]['template']){
          ...
          return 'lib/contentfly-ui/assets/views/dashboard.html?v=' + APP_VERSION;
        }
    ...
    $stateProvider.state({
      ...
      templateUrl: function ($stateParams){
        if(extendedRoutes['error'] &&  extendedRoutes['error'][0]['template']){
          ...
          return 'lib/contentfly-ui/assets/views/error.html?v=' + APP_VERSION;
        }
      },
      controllerProvider: function ($stateParams) {
    ...
    $stateProvider.state({
      ...
      templateUrl: function ($stateParams){
        if(extendedRoutes['login'] &&  extendedRoutes['login'][0]['template']){
          ...
          return 'lib/contentfly-ui/assets/views/login.html?v=' + APP_VERSION;
        }
      },
      controllerProvider: function ($stateParams) {
    ...
    $stateProvider.state({
      ...
      onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal, $resource) {
        modal = $uibModal.open({
          templateUrl: 'lib/contentfly-ui/assets/views/list.html?v=' + APP_VERSION,
    ...
    $stateProvider.state({
      ...
      templateUrl: function ($stateParams){
        if(extendedRoutes['list'] &&  extendedRoutes['list'][0]['template'] && (!extendedRoutes['list'][0]['stateParams'] || extendedRoutes['list'][0]['stateParams'] && extendedRoutes['list'][0]['stateParams']['entity'] == $stateParams.entity)){
          ...
          return 'lib/contentfly-ui/assets/views/list.html?v=' + APP_VERSION;
        }
    ...
    $stateProvider.state({
      ...
      templateUrl: function ($stateParams){
        if(extendedRoutes['settings'] &&  extendedRoutes['settings'][0]['template']){
          ...
          return 'lib/contentfly-ui/assets/views/settings.html?v=' + APP_VERSION;
        }
      },
      controllerProvider: function ($stateParams) {
    ...
    $stateProvider.state({
      ...
      templateUrl: function ($stateParams){
        if(extendedRoutes['files'] &&  extendedRoutes['files'][0]['template']){
          ...
          return 'lib/contentfly-ui/assets/views/files.html?v=' + APP_VERSION;
        }
      },
      controllerProvider: function ($stateParams) {
    ...
    for (var route in uiRoutes){
      ...
      var templatePath   = uiRoutes[route]['templateName'].substr(0, 8) == '/plugins' ? uiRoutes[route]['templateName'] : '/custom/Frontendlib/contentfly-ui/assets/views/' + uiRoutes[route]['templateName'];
