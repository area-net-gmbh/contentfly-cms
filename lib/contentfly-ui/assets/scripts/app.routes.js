(function() {
  ...
  function stateProvider($stateProvider, $urlRouterProvider) {
    ...
    for (var route in uiRoutes){
      ...
      var templatePath   = uiRoutes[route]['templateName'].substr(0, 8) == 'plugins' ? uiRoutes[route]['templateName'] : 'custom/Frontend/contentfly-ui/views/' + uiRoutes[route]['templateName'];
