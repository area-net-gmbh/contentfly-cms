    ...
    function pimPermissions(localStorageService){
        return {
            ...
            templateUrl: function(){
                return 'lib/contentfly-ui/assets/types/permissions/permissions.html?v=' + APP_VERSION
            },
            link: function(scope, element, attrs){
                ...
                function init(){
                    var excludedEntities = ['PIM\\Permission', 'PIM\\Log', 'PIM\\Tag', 'PIM\\ThumbnailSetting','_hash'];
