...
class AuthController extends BaseController
{
    ...
    public function loginAction(Request $request)
    {
        ...
        return new JsonResponse(array('message' => 'Login successful', 'token' => $token->getToken(), 'user' => array('id' => $user->getId(),'alias' => $user->getAlias(), 'group' => $user->getGroup(), 'isAdmin' => $user->getIsAdmin())));
    }
