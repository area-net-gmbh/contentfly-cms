 ...
 * @PIM\Config(label = "Produkte", labelProperty="artikel", sortBy="artikel", sortOrder="ASC", tabs="{'img': 'Bilder', 'cross': 'Cross-Selling', 'filter': 'Filter', 'files': 'Dateien'}", hide=true)
 */
